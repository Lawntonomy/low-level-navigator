...
namespace hardware
{
    struct gpio_update
    {
        ...
        gpio_update(config_defines::config_1::gpio_num pin_in, uint16_t value_in, uint16_t max_in, uint32_t time_in):
    ...
    struct neopixel_update
    {
        ...
        neopixel_update()
        {};
        neopixel_update(uint8_t led_num, uint8_t r, uint8_t g, uint8_t b):led_num(led_num), r(r), g(g),b(b)
        {};
    };
